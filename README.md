...
[![Awesome Regex](media/awesome-regex-banner.svg)](https://github.com/slevithan/awesome-regex) ⭐ 351 | 🐛 0 | 📅 2025-12-14
...
Contributions are welcome. Add links through pull requests ([guidelines](origin/CONTRIBUTING.md)).
...
[Regex+](https://github.com/slevithan/regex) ⭐ 630 | 🐛 1 | 🌐 JavaScript | 📅 2025-12-16 is a lightweight JavaScript library for more readable, high-performance, native JavaScript regexes with powerful features including free spacing, atomic groups, possessive quantifiers, subroutines, definition groups, and context-aware interpolation.
...
* [RegExr](https://regexr.com/) \[[*GitHub*](https://github.com/gskinner/regexr/) ⭐ 10,309 | 🐛 218 | 🌐 JavaScript | 📅 2025-07-17] - **Best open source tester**.
  * Flavors: JavaScript, PCRE.
  * Languages: 🇺🇸, 🇨🇳 ([fork](https://regexr-cn.com/)).
* [RegexLearn](https://regexlearn.com/playground) \[[*GitHub*](https://github.com/aykutkardas/regexlearn.com/blob/develop/src/pages/%5Blang%5D/playground.tsx) ⭐ 3,959 | 🐛 26 | 🌐 TypeScript | 📅 2025-06-18] - **Best multilingual tester** (JavaScript).
  * Languages: 🇺🇸, 🇹🇷, 🇷🇺, 🇪🇸, 🇨🇳, 🇩🇪, 🇺🇦, 🇫🇷, 🇵🇱, 🇰🇷, 🇧🇷, 🇨🇿, 🇬🇪.
...
* fancy-regex (Rust library): [fancy-regex playground](https://fancy-regex.github.io/fancy-regex/) \[[*GitHub*](https://github.com/fancy-regex/fancy-regex/tree/main/playground) ⭐ 573 | 🐛 15 | 🌐 Rust | 📅 2026-02-10].
* Swift: [Swift Regex](https://swiftregex.com/) \[[*GitHub*](https://github.com/swiftfiddle/swiftregex) ⭐ 191 | 🐛 6 | 🌐 Swift | 📅 2026-02-10] - Includes regex debugger, DSL builder.
...
* [CyrilEx](https://extendsclass.com/regex-tester.html) \[[*GitHub*](https://github.com/cyrilbois/cyrilex) ⭐ 93 | 🐛 4 | 🌐 JavaScript | 📅 2024-05-17] - Java, JavaScript, MySQL, PHP, Python, Ruby.
...
* [Regex Generator](https://regex-generator.olafneumann.org/) \[[*GitHub*](https://github.com/noxone/regex-generator) ⭐ 461 | 🐛 15 | 🌐 Kotlin | 📅 2026-02-12] - Generate simple regexes from a sample text.
...
* [Regex Nodes](https://johannesvollmer.com/regex-nodes/) \[[*GitHub*](https://github.com/johannesvollmer/regex-nodes) ⭐ 41 | 🐛 4 | 🌐 JavaScript | 📅 2024-01-05] - Graphical editor with visual hierarchy. Flavor: JavaScript.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 59,810 | 🐛 114 | 🌐 Rust | 📅 2025-12-17 - Better and faster grep. Recursively searches directories while respecting gitignore rules and skipping hidden/binary files.
...
* [PowerGREP](https://www.powergrep.com/) (Windows, $159) - Can search through archives, binary files, PDFs, docs/sheets, emails, etc., via its GUI or the command line.
  * Flavors: Emulates hundreds of flavors/versions.
* [PowerRename](https://github.com/microsoft/PowerToys) ⭐ 129,454 | 🐛 8,131 | 🌐 C# | 📅 2026-02-12 (Windows) - Rename files using regexes.
...
* [The Modern JavaScript Tutorial: Regular expressions](https://javascript.info/regular-expressions) \[[*GitHub*](https://github.com/javascript-tutorial/en.javascript.info) ⭐ 25,120 | 🐛 511 | 🌐 HTML | 📅 2025-11-20] - Guide to using regexes in JavaScript.
...
* [Regular Expressions for Regular Folk](https://refrf.dev/) \[[*GitHub*](https://github.com/shreyasminocha/regex-for-regular-folk) ⭐ 290 | 🐛 23 | 🌐 JavaScript | 📅 2023-06-10] - Visual, example-based ebook for beginners.

</details>

### With interactive exercises

* [RegexLearn](https://regexlearn.com/) \[[*GitHub*](https://github.com/aykutkardas/regexlearn.com) ⭐ 3,959 | 🐛 26 | 🌐 TypeScript | 📅 2025-06-18] - Interactive tutorial and practice problems.
  * Languages: 🇺🇸, 🇹🇷, 🇷🇺, 🇪🇸, 🇨🇳, 🇩🇪, 🇺🇦, 🇫🇷, 🇵🇱, 🇰🇷, 🇧🇷, 🇨🇿, 🇬🇪.
...
* RE2: [Syntax](https://github.com/google/re2/wiki/Syntax) ⭐ 9,596 | 🐛 11 | 🌐 C++ | 📅 2026-01-22.
* Oniguruma: [RE](https://github.com/kkos/oniguruma/blob/master/doc/RE) ⚠️ Archived.
* Onigmo: [RE](https://github.com/k-takata/Onigmo/blob/master/doc/RE) ⭐ 671 | 🐛 50 | 🌐 C | 📅 2024-06-15.
...
* [Python: re](https://github.com/python/cpython/tree/main/Lib/re) ⭐ 71,462 | 🐛 9,202 | 🌐 Python | 📅 2026-02-12 and [regex](https://github.com/mrabarnett/mrab-regex) ⭐ 573 | 🐛 79 | 🌐 C | 📅 2026-01-14 - Standard and extended regex libraries.
* JavaScript:
  * [V8: Irregexp](https://github.com/v8/v8/tree/main/src/regexp) ⭐ 24,838 | 🐛 7 | 🌐 C++ | 📅 2026-02-12 - Regex engine used by Chrome, Edge, [Firefox](https://hacks.mozilla.org/2020/06/a-new-regexp-engine-in-spidermonkey/), etc.
  * [JavaScriptCore: RegExp](https://github.com/WebKit/WebKit/blob/main/Source/JavaScriptCore/runtime/RegExp.cpp) ⭐ 9,595 | 🐛 1,856 | 🌐 JavaScript | 📅 2026-02-12 - Regex engine used by Safari.
* [Java: java.util.regex](https://github.com/openjdk/jdk/tree/master/src/java.base/share/classes/java/util/regex) ⭐ 22,489 | 🐛 384 | 🌐 Java | 📅 2026-02-12 - JDK standard regexes.
* [.NET: System.Text.RegularExpressions](https://github.com/dotnet/runtime/tree/main/src/libraries/System.Text.RegularExpressions) ⭐ 17,561 | 🐛 8,356 | 🌐 C# | 📅 2026-02-12 - Shared by all .NET languages (C#, VB, etc.).
* [RE2](https://github.com/google/re2) ⭐ 9,596 | 🐛 11 | 🌐 C++ | 📅 2026-01-22 - Popular C++ regex library used by Go, etc. Non-backtracking engine.
* [Hyperscan](https://github.com/intel/hyperscan) ⭐ 5,307 | 🐛 194 | 🌐 C++ | 📅 2025-04-02 - Intel's high-performance library, used for [DPI](https://en.wikipedia.org/wiki/Deep_packet_inspection).
* [Rust: regex](https://github.com/rust-lang/regex) ⭐ 3,898 | 🐛 54 | 🌐 Rust | 📅 2026-02-03 - Non-backtracking engine.
* [ICU](https://github.com/unicode-org/icu/blob/main/icu4c/source/i18n/regexcmp.cpp) ⭐ 3,407 | 🐛 101 | 🌐 C++ | 📅 2026-02-12 - Unicode org's package with full Unicode support.
* [Oniguruma](https://github.com/kkos/oniguruma) ⚠️ Archived - C regex library used by Ruby 1.9, TextMate grammars, etc.
* [Perl](https://github.com/Perl/perl5/blob/blead/regexp.h) ⭐ 2,230 | 🐛 2,391 | 🌐 Perl | 📅 2026-02-11 - See [perlreguts](https://perldoc.perl.org/perlreguts).
* [PCRE2](https://github.com/PCRE2Project/pcre2) ⭐ 1,218 | 🐛 46 | 🌐 C | 📅 2026-02-09 - Popular C regex library used by PHP, R, etc.
* [Onigmo](https://github.com/k-takata/Onigmo) ⭐ 671 | 🐛 50 | 🌐 C | 📅 2024-06-15 - Forked from Oniguruma. Used by Ruby 2.0+.
...
* Ron Buckton: [Regular Expression Feature Comparisons](https://rbuckton.github.io/regexp-features/) \[[*GitHub*](https://github.com/rbuckton/regexp-features) ⭐ 16 | 🐛 6 | 🌐 JavaScript | 📅 2024-05-08].
...
* Cross-engine benchmarking libraries: [rebar](https://github.com/BurntSushi/rebar) ⭐ 286 | 🐛 11 | 🌐 Python | 📅 2025-12-20, [regex-benchmark](https://github.com/mariomka/regex-benchmark) ⚠️ Archived.
...
* [vuln-regex-detector](https://github.com/davisjam/vuln-regex-detector) ⭐ 340 | 🐛 24 | 🌐 Perl | 📅 2022-01-07 - Perl library for detecting ReDoS vulnerability.
* [recheck](https://github.com/makenowjust-labs/recheck) ⭐ 289 | 🐛 12 | 🌐 Scala | 📅 2026-02-11 \[[*home*](https://makenowjust-labs.github.io/recheck/)] - JavaScript and Scala library for detecting ReDoS vulnerability. Can be used as an ESLint plugin.
...
* Use other engines via WebAssembly: [node-re2](https://github.com/uhop/node-re2) ⭐ 535 | 🐛 5 | 🌐 C++ | 📅 2026-02-09 (RE2), [rregex](https://github.com/2fd/rregex) ⭐ 30 | 🐛 4 | 🌐 JavaScript | 📅 2026-02-03 (Rust's `regex`), [vscode-oniguruma](https://github.com/microsoft/vscode-oniguruma) ⭐ 134 | 🐛 6 | 🌐 TypeScript | 📅 2026-02-07 (Oniguruma).
* [Oniguruma-To-ES](https://github.com/slevithan/oniguruma-to-es) ⭐ 135 | 🐛 5 | 🌐 JavaScript | 📅 2025-11-27 - Convert Oniguruma patterns to native JavaScript regexes.

### Abstracted regex syntax

* [Melody](https://github.com/yoav-lavi/melody) ⭐ 4,745 | 🐛 8 | 🌐 Rust | 📅 2024-11-24 \[[*docs*](https://yoav-lavi.github.io/melody/book/)] - A language that compiles to regexes.
* Compose with functions: [compose-regexp.js](https://github.com/compose-regexp/compose-regexp.js) ⭐ 149 | 🐛 2 | 🌐 JavaScript | 📅 2024-09-26, [VerbalExpressions](https://github.com/VerbalExpressions/JSVerbalExpressions) ⭐ 12,156 | 🐛 29 | 🌐 JavaScript | 📅 2024-08-07 (implementations for [many languages](https://verbalexpressions.github.io/)), [magic-regexp](https://github.com/unjs/magic-regexp) ⭐ 4,313 | 🐛 36 | 🌐 TypeScript | 📅 2026-02-11 \[[*home*](https://regexp.dev/)], [Super Expressive](https://github.com/francisrstokes/super-expressive) ⭐ 4,635 | 🐛 10 | 🌐 JavaScript | 📅 2024-07-05 \[[*playground*](https://nartc.github.io/ng-super-expressive/)].
...
* [arkregex](https://github.com/arktypeio/arktype/tree/main/ark/regex) ⭐ 7,611 | 🐛 231 | 🌐 TypeScript | 📅 2026-02-02 - `RegExp`-equivalent constructor with TS types.
* [regexgen](https://github.com/devongovett/regexgen) ⭐ 3,425 | 🐛 15 | 🌐 JavaScript | 📅 2024-02-15 - Generate a regex that matches a set of strings.
...
* [eslint-plugin-regexp](https://github.com/ota-meshi/eslint-plugin-regexp) ⭐ 756 | 🐛 17 | 🌐 TypeScript | 📅 2026-02-10 \[[*home*](https://ota-meshi.github.io/eslint-plugin-regexp/)] - ESLint plugin for finding regex mistakes, etc.
...
* [regex-utils](https://github.com/gruhn/regex-utils) ⭐ 20 | 🐛 5 | 🌐 TypeScript | 📅 2026-01-18 - Check regex equivalence, build regex intersections, and other utilities.
* Partial regex matching: [regex-partial-match](https://github.com/TomStrepsil/regex-partial-match) ⭐ 3 | 🐛 1 | 🌐 TypeScript | 📅 2026-02-03, [incr-regex-package](https://github.com/nurulc/incr-regex-package) ⭐ 13 | 🐛 15 | 🌐 JavaScript | 📅 2023-12-15.
* [regex-to-mermaid](https://github.com/tayles/regex-to-mermaid) ⭐ 1 | 🐛 1 | 🌐 TypeScript | 📅 2025-11-02 - Generate Mermaid diagrams to visualize regexes.
...
* ES2018 added [flag `s`](https://github.com/tc39/proposal-regexp-dotall-flag) ⚠️ Archived (`dotAll`), [lookbehind](https://github.com/tc39/proposal-regexp-lookbehind) ⚠️ Archived, [named capture](https://github.com/tc39/proposal-regexp-named-groups) ⚠️ Archived, and [Unicode properties](https://github.com/tc39/proposal-regexp-unicode-property-escapes) ⚠️ Archived (via `\p{…}` and `\P{…}` which require flag `u`; see [list](https://github.com/mathiasbynens/regexpu-core/blob/main/property-escapes.md) ⭐ 80 | 🐛 4 | 🌐 JavaScript | 📅 2025-09-22).
* ES2024 added [flag `v`](https://github.com/tc39/proposal-regexp-v-flag) ⚠️ Archived (`unicodeSets`) \[[*explainer*](https://v8.dev/features/regexp-v-flag)] as an upgrade to flag `u`, which adds a set of multicharacter "properties of strings" to `\p{…}`, multicharacter elements within character classes via `\p{…}` and `\q{…|…}`, nested character classes, set operators `[…--…]` and `[…&&…]`, and different escaping rules within character classes. It also fixes case-insensitive matching for `\p` and `\P` within negated `[^…]`.
* ES2022 added [flag `d`](https://github.com/tc39/proposal-regexp-match-indices) ⚠️ Archived (`hasIndices`), which provides start/end indices for matched substrings.
* ES2025 added [modifiers](https://github.com/tc39/proposal-regexp-modifiers) ⭐ 47 | 🐛 4 | 🌐 HTML | 📅 2024-10-08 like `(?ims:…)`, [duplicate named capturing groups](https://github.com/tc39/proposal-duplicate-named-capturing-groups) ⭐ 30 | 🐛 1 | 📅 2023-03-11 in separate alternation paths, and [`RegExp.escape`](https://github.com/tc39/proposal-regex-escaping) ⚠️ Archived.
...
> Editions from ES2019 onward have added additional Unicode properties that can be used via `\p{…}` and `\P{…}`. ES2021 added string method [`replaceAll`](https://github.com/tc39/proposal-string-replaceall) ⚠️ Archived, although the only difference from ES3's `replace` when given a regex is that it throws if not using flag `g`.
...
* Backcompat libraries: [regexpu](https://github.com/mathiasbynens/regexpu) ⭐ 239 | 🐛 3 | 🌐 JavaScript | 📅 2024-09-18, [regenerate](https://github.com/mathiasbynens/regenerate) ⭐ 375 | 🐛 6 | 🌐 JavaScript | 📅 2021-12-29 ([Unicode property sets](https://github.com/mathiasbynens/regenerate-unicode-properties) ⭐ 20 | 🐛 0 | 🌐 JavaScript | 📅 2025-09-09).
...
* [Legacy RegExp features](https://github.com/tc39/proposal-regexp-legacy-features) ⭐ 48 | 🐛 7 | 📅 2023-10-25 (2015) - Standardization of legacy features.
* [Restrict subclassing support in built-ins](https://github.com/tc39/proposal-rm-builtin-subclassing) ⭐ 42 | 🐛 14 | 📅 2024-04-30 (2020) - Scaled back `RegExp` subclassing.
* [Extended mode and comments](https://github.com/tc39/proposal-regexp-x-mode) ⭐ 31 | 🐛 9 | 🌐 JavaScript | 📅 2021-10-28 (2021) - Flag `x` (`extended`) with insignificant whitespace and line comments (`#…`), plus inline comments via `(?#…)`.
* [Atomic operators](https://github.com/tc39/proposal-regexp-atomic-operators) ⭐ 21 | 🐛 5 | 🌐 JavaScript | 📅 2026-01-22 (2021) - Atomic groups via `(?>…)` and possessive quantifiers (ex: `*+`, `++`).
* [Buffer boundaries](https://github.com/tc39/proposal-regexp-buffer-boundaries) ⭐ 10 | 🐛 4 | 🌐 HTML | 📅 2022-05-28 (2021) - Anchors `\A` and `\z`, not affected by flag `m`.
* [\R escape](https://github.com/tc39/proposal-regexp-r-escape) ⭐ 5 | 🐛 3 | 🌐 HTML | 📅 2021-12-04 (2021) - Outside character classes, `\R` matches any line terminator.
...
Awesome Regex was created by [Steven Levithan](https://github.com/slevithan) and [contributors](https://github.com/slevithan/awesome-regex/graphs/contributors) ⭐ 351 | 🐛 0 | 📅 2025-12-14.
