...
* RE2: [Syntax](https://github.com/google/re2/wiki/Syntax) ⭐ 9,590 | 🐛 12 | 🌐 C++ | 📅 2026-01-22.
* Oniguruma: [RE](https://github.com/kkos/oniguruma/blob/master/doc/RE) ⚠️ Archived.
* Onigmo: [RE](https://github.com/k-takata/Onigmo/blob/master/doc/RE) ⭐ 670 | 🐛 50 | 🌐 C | 📅 2024-06-15.
...
* Cross-engine benchmarking libraries: [rebar](https://github.com/BurntSushi/rebar) ⭐ 285 | 🐛 11 | 🌐 Python | 📅 2025-12-20, [regex-benchmark](https://github.com/mariomka/regex-benchmark) ⚠️ Archived.
...
* [arkregex](https://github.com/arktypeio/arktype/tree/main/ark/regex) ⭐ 7,604 | 🐛 229 | 🌐 TypeScript | 📅 2026-02-02 - `RegExp`-equivalent constructor with TS types.
