...
* [RegExr](https://regexr.com/) \[[*GitHub*](https://github.com/gskinner/regexr/) ⭐ 10,310 | 🐛 218 | 🌐 JavaScript | 📅 2025-07-17] - **Best open source tester**.
  * Flavors: JavaScript, PCRE.
  * Languages: 🇺🇸, 🇨🇳 ([fork](https://regexr-cn.com/)).
* [RegexLearn](https://regexlearn.com/playground) \[[*GitHub*](https://github.com/aykutkardas/regexlearn.com/blob/develop/src/pages/%5Blang%5D/playground.tsx) ⭐ 3,960 | 🐛 26 | 🌐 TypeScript | 📅 2025-06-18] - **Best multilingual tester** (JavaScript).
  * Languages: 🇺🇸, 🇹🇷, 🇷🇺, 🇪🇸, 🇨🇳, 🇩🇪, 🇺🇦, 🇫🇷, 🇵🇱, 🇰🇷, 🇧🇷, 🇨🇿, 🇬🇪.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 59,846 | 🐛 113 | 🌐 Rust | 📅 2026-02-13 - Better and faster grep. Recursively searches directories while respecting gitignore rules and skipping hidden/binary files.
...
* [PowerGREP](https://www.powergrep.com/) (Windows, $159) - Can search through archives, binary files, PDFs, docs/sheets, emails, etc., via its GUI or the command line.
  * Flavors: Emulates hundreds of flavors/versions.
* [PowerRename](https://github.com/microsoft/PowerToys) ⭐ 129,681 | 🐛 8,135 | 🌐 C# | 📅 2026-02-13 (Windows) - Rename files using regexes.
...
* [RegexLearn](https://regexlearn.com/) \[[*GitHub*](https://github.com/aykutkardas/regexlearn.com) ⭐ 3,960 | 🐛 26 | 🌐 TypeScript | 📅 2025-06-18] - Interactive tutorial and practice problems.
  * Languages: 🇺🇸, 🇹🇷, 🇷🇺, 🇪🇸, 🇨🇳, 🇩🇪, 🇺🇦, 🇫🇷, 🇵🇱, 🇰🇷, 🇧🇷, 🇨🇿, 🇬🇪.
...
* RE2: [Syntax](https://github.com/google/re2/wiki/Syntax) ⭐ 9,597 | 🐛 11 | 🌐 C++ | 📅 2026-01-22.
...
* [Python: re](https://github.com/python/cpython/tree/main/Lib/re) ⭐ 71,477 | 🐛 9,215 | 🌐 Python | 📅 2026-02-12 and [regex](https://github.com/mrabarnett/mrab-regex) ⭐ 573 | 🐛 79 | 🌐 C | 📅 2026-01-14 - Standard and extended regex libraries.
* JavaScript:
  * [V8: Irregexp](https://github.com/v8/v8/tree/main/src/regexp) ⭐ 24,845 | 🐛 7 | 🌐 C++ | 📅 2026-02-12 - Regex engine used by Chrome, Edge, [Firefox](https://hacks.mozilla.org/2020/06/a-new-regexp-engine-in-spidermonkey/), etc.
  * [JavaScriptCore: RegExp](https://github.com/WebKit/WebKit/blob/main/Source/JavaScriptCore/runtime/RegExp.cpp) ⭐ 9,597 | 🐛 1,868 | 🌐 JavaScript | 📅 2026-02-13 - Regex engine used by Safari.
* [Java: java.util.regex](https://github.com/openjdk/jdk/tree/master/src/java.base/share/classes/java/util/regex) ⭐ 22,493 | 🐛 392 | 🌐 Java | 📅 2026-02-13 - JDK standard regexes.
* [.NET: System.Text.RegularExpressions](https://github.com/dotnet/runtime/tree/main/src/libraries/System.Text.RegularExpressions) ⭐ 17,572 | 🐛 8,329 | 🌐 C# | 📅 2026-02-13 - Shared by all .NET languages (C#, VB, etc.).
* [RE2](https://github.com/google/re2) ⭐ 9,597 | 🐛 11 | 🌐 C++ | 📅 2026-01-22 - Popular C++ regex library used by Go, etc. Non-backtracking engine.
...
* [ICU](https://github.com/unicode-org/icu/blob/main/icu4c/source/i18n/regexcmp.cpp) ⭐ 3,408 | 🐛 99 | 🌐 C++ | 📅 2026-02-12 - Unicode org's package with full Unicode support.
* [Oniguruma](https://github.com/kkos/oniguruma) ⚠️ Archived - C regex library used by Ruby 1.9, TextMate grammars, etc.
* [Perl](https://github.com/Perl/perl5/blob/blead/regexp.h) ⭐ 2,230 | 🐛 2,385 | 🌐 Perl | 📅 2026-02-12 - See [perlreguts](https://perldoc.perl.org/perlreguts).
* [PCRE2](https://github.com/PCRE2Project/pcre2) ⭐ 1,218 | 🐛 47 | 🌐 C | 📅 2026-02-09 - Popular C regex library used by PHP, R, etc.
...
* [arkregex](https://github.com/arktypeio/arktype/tree/main/ark/regex) ⭐ 7,613 | 🐛 231 | 🌐 TypeScript | 📅 2026-02-02 - `RegExp`-equivalent constructor with TS types.
