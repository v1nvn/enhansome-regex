...
* [RegexLearn](https://regexlearn.com/playground) \[[*GitHub*](https://github.com/aykutkardas/regexlearn.com/blob/develop/src/pages/%5Blang%5D/playground.tsx) ⭐ 3,958 | 🐛 26 | 🌐 TypeScript | 📅 2025-06-18] - **Best multilingual tester** (JavaScript).
  * Languages: 🇺🇸, 🇹🇷, 🇷🇺, 🇪🇸, 🇨🇳, 🇩🇪, 🇺🇦, 🇫🇷, 🇵🇱, 🇰🇷, 🇧🇷, 🇨🇿, 🇬🇪.
...
* [Regex Generator](https://regex-generator.olafneumann.org/) \[[*GitHub*](https://github.com/noxone/regex-generator) ⭐ 461 | 🐛 14 | 🌐 Kotlin | 📅 2026-02-10] - Generate simple regexes from a sample text.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 59,771 | 🐛 114 | 🌐 Rust | 📅 2025-12-17 - Better and faster grep. Recursively searches directories while respecting gitignore rules and skipping hidden/binary files.
...
* [PowerGREP](https://www.powergrep.com/) (Windows, $159) - Can search through archives, binary files, PDFs, docs/sheets, emails, etc., via its GUI or the command line.
  * Flavors: Emulates hundreds of flavors/versions.
* [PowerRename](https://github.com/microsoft/PowerToys) ⭐ 129,221 | 🐛 8,135 | 🌐 C# | 📅 2026-02-11 (Windows) - Rename files using regexes.
...
* [The Modern JavaScript Tutorial: Regular expressions](https://javascript.info/regular-expressions) \[[*GitHub*](https://github.com/javascript-tutorial/en.javascript.info) ⭐ 25,117 | 🐛 511 | 🌐 HTML | 📅 2025-11-20] - Guide to using regexes in JavaScript.
...
* [RegexLearn](https://regexlearn.com/) \[[*GitHub*](https://github.com/aykutkardas/regexlearn.com) ⭐ 3,958 | 🐛 26 | 🌐 TypeScript | 📅 2025-06-18] - Interactive tutorial and practice problems.
  * Languages: 🇺🇸, 🇹🇷, 🇷🇺, 🇪🇸, 🇨🇳, 🇩🇪, 🇺🇦, 🇫🇷, 🇵🇱, 🇰🇷, 🇧🇷, 🇨🇿, 🇬🇪.
...
* [Python: re](https://github.com/python/cpython/tree/main/Lib/re) ⭐ 71,450 | 🐛 9,204 | 🌐 Python | 📅 2026-02-10 and [regex](https://github.com/mrabarnett/mrab-regex) ⭐ 573 | 🐛 79 | 🌐 C | 📅 2026-01-14 - Standard and extended regex libraries.
* JavaScript:
  * [V8: Irregexp](https://github.com/v8/v8/tree/main/src/regexp) ⭐ 24,836 | 🐛 7 | 🌐 C++ | 📅 2026-02-11 - Regex engine used by Chrome, Edge, [Firefox](https://hacks.mozilla.org/2020/06/a-new-regexp-engine-in-spidermonkey/), etc.
  * [JavaScriptCore: RegExp](https://github.com/WebKit/WebKit/blob/main/Source/JavaScriptCore/runtime/RegExp.cpp) ⭐ 9,597 | 🐛 1,870 | 🌐 JavaScript | 📅 2026-02-11 - Regex engine used by Safari.
* [Java: java.util.regex](https://github.com/openjdk/jdk/tree/master/src/java.base/share/classes/java/util/regex) ⭐ 22,487 | 🐛 385 | 🌐 Java | 📅 2026-02-11 - JDK standard regexes.
* [.NET: System.Text.RegularExpressions](https://github.com/dotnet/runtime/tree/main/src/libraries/System.Text.RegularExpressions) ⭐ 17,559 | 🐛 8,378 | 🌐 C# | 📅 2026-02-11 - Shared by all .NET languages (C#, VB, etc.).
...
* [ICU](https://github.com/unicode-org/icu/blob/main/icu4c/source/i18n/regexcmp.cpp) ⭐ 3,407 | 🐛 103 | 🌐 C++ | 📅 2026-02-09 - Unicode org's package with full Unicode support.
* [Oniguruma](https://github.com/kkos/oniguruma) ⚠️ Archived - C regex library used by Ruby 1.9, TextMate grammars, etc.
* [Perl](https://github.com/Perl/perl5/blob/blead/regexp.h) ⭐ 2,230 | 🐛 2,390 | 🌐 Perl | 📅 2026-02-10 - See [perlreguts](https://perldoc.perl.org/perlreguts).
* [PCRE2](https://github.com/PCRE2Project/pcre2) ⭐ 1,217 | 🐛 46 | 🌐 C | 📅 2026-02-09 - Popular C regex library used by PHP, R, etc.
...
* [recheck](https://github.com/makenowjust-labs/recheck) ⭐ 289 | 🐛 14 | 🌐 Scala | 📅 2026-02-11 \[[*home*](https://makenowjust-labs.github.io/recheck/)] - JavaScript and Scala library for detecting ReDoS vulnerability. Can be used as an ESLint plugin.
...
* [arkregex](https://github.com/arktypeio/arktype/tree/main/ark/regex) ⭐ 7,608 | 🐛 231 | 🌐 TypeScript | 📅 2026-02-02 - `RegExp`-equivalent constructor with TS types.
...
* [eslint-plugin-regexp](https://github.com/ota-meshi/eslint-plugin-regexp) ⭐ 755 | 🐛 17 | 🌐 TypeScript | 📅 2026-02-10 \[[*home*](https://ota-meshi.github.io/eslint-plugin-regexp/)] - ESLint plugin for finding regex mistakes, etc.
