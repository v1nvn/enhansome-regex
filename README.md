...
[![Awesome Regex](media/awesome-regex-banner.svg)](https://github.com/slevithan/awesome-regex) ⭐ 352 | 🐛 0 | 📅 2025-12-14
...
* Swift: [Swift Regex](https://swiftregex.com/) \[[*GitHub*](https://github.com/swiftfiddle/swiftregex) ⭐ 192 | 🐛 6 | 🌐 Swift | 📅 2026-02-12] - Includes regex debugger, DSL builder.
...
* [Regex Generator](https://regex-generator.olafneumann.org/) \[[*GitHub*](https://github.com/noxone/regex-generator) ⭐ 461 | 🐛 15 | 🌐 Kotlin | 📅 2026-02-13] - Generate simple regexes from a sample text.
...
* [Regex Vis](https://regex-vis.com/) \[[*GitHub*](https://github.com/Bowen7/regex-vis) ⭐ 4,243 | 🐛 19 | 🌐 TypeScript | 📅 2026-01-02] - Create railroad diagrams, with visual editor. Flavor: JavaScript.
  * Languages: 🇺🇸, 🇨🇳.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 59,865 | 🐛 113 | 🌐 Rust | 📅 2026-02-13 - Better and faster grep. Recursively searches directories while respecting gitignore rules and skipping hidden/binary files.
...
* [PowerGREP](https://www.powergrep.com/) (Windows, $159) - Can search through archives, binary files, PDFs, docs/sheets, emails, etc., via its GUI or the command line.
  * Flavors: Emulates hundreds of flavors/versions.
* [PowerRename](https://github.com/microsoft/PowerToys) ⭐ 129,761 | 🐛 8,146 | 🌐 C# | 📅 2026-02-13 (Windows) - Rename files using regexes.
...
* [The Modern JavaScript Tutorial: Regular expressions](https://javascript.info/regular-expressions) \[[*GitHub*](https://github.com/javascript-tutorial/en.javascript.info) ⭐ 25,113 | 🐛 512 | 🌐 HTML | 📅 2025-11-20] - Guide to using regexes in JavaScript.
...
* RE2: [Syntax](https://github.com/google/re2/wiki/Syntax) ⭐ 9,599 | 🐛 11 | 🌐 C++ | 📅 2026-01-22.
...
* [Python: re](https://github.com/python/cpython/tree/main/Lib/re) ⭐ 71,488 | 🐛 9,210 | 🌐 Python | 📅 2026-02-13 and [regex](https://github.com/mrabarnett/mrab-regex) ⭐ 574 | 🐛 79 | 🌐 C | 📅 2026-01-14 - Standard and extended regex libraries.
* JavaScript:
  * [V8: Irregexp](https://github.com/v8/v8/tree/main/src/regexp) ⭐ 24,842 | 🐛 7 | 🌐 C++ | 📅 2026-02-13 - Regex engine used by Chrome, Edge, [Firefox](https://hacks.mozilla.org/2020/06/a-new-regexp-engine-in-spidermonkey/), etc.
  * [JavaScriptCore: RegExp](https://github.com/WebKit/WebKit/blob/main/Source/JavaScriptCore/runtime/RegExp.cpp) ⭐ 9,600 | 🐛 1,860 | 🌐 JavaScript | 📅 2026-02-14 - Regex engine used by Safari.
* [Java: java.util.regex](https://github.com/openjdk/jdk/tree/master/src/java.base/share/classes/java/util/regex) ⭐ 22,495 | 🐛 391 | 🌐 Java | 📅 2026-02-14 - JDK standard regexes.
* [.NET: System.Text.RegularExpressions](https://github.com/dotnet/runtime/tree/main/src/libraries/System.Text.RegularExpressions) ⭐ 17,574 | 🐛 8,338 | 🌐 C# | 📅 2026-02-14 - Shared by all .NET languages (C#, VB, etc.).
* [RE2](https://github.com/google/re2) ⭐ 9,599 | 🐛 11 | 🌐 C++ | 📅 2026-01-22 - Popular C++ regex library used by Go, etc. Non-backtracking engine.
* [Hyperscan](https://github.com/intel/hyperscan) ⭐ 5,308 | 🐛 195 | 🌐 C++ | 📅 2026-02-13 - Intel's high-performance library, used for [DPI](https://en.wikipedia.org/wiki/Deep_packet_inspection).
* [Rust: regex](https://github.com/rust-lang/regex) ⭐ 3,897 | 🐛 54 | 🌐 Rust | 📅 2026-02-03 - Non-backtracking engine.
* [ICU](https://github.com/unicode-org/icu/blob/main/icu4c/source/i18n/regexcmp.cpp) ⭐ 3,406 | 🐛 100 | 🌐 C++ | 📅 2026-02-13 - Unicode org's package with full Unicode support.
* [Oniguruma](https://github.com/kkos/oniguruma) ⚠️ Archived - C regex library used by Ruby 1.9, TextMate grammars, etc.
* [Perl](https://github.com/Perl/perl5/blob/blead/regexp.h) ⭐ 2,229 | 🐛 2,386 | 🌐 Perl | 📅 2026-02-13 - See [perlreguts](https://perldoc.perl.org/perlreguts).
...
* [recheck](https://github.com/makenowjust-labs/recheck) ⭐ 289 | 🐛 12 | 🌐 Scala | 📅 2026-02-12 \[[*home*](https://makenowjust-labs.github.io/recheck/)] - JavaScript and Scala library for detecting ReDoS vulnerability. Can be used as an ESLint plugin.
...
* Use other engines via WebAssembly: [node-re2](https://github.com/uhop/node-re2) ⭐ 536 | 🐛 5 | 🌐 C++ | 📅 2026-02-09 (RE2), [rregex](https://github.com/2fd/rregex) ⭐ 30 | 🐛 4 | 🌐 JavaScript | 📅 2026-02-03 (Rust's `regex`), [vscode-oniguruma](https://github.com/microsoft/vscode-oniguruma) ⭐ 134 | 🐛 6 | 🌐 TypeScript | 📅 2026-02-07 (Oniguruma).
...
* [Melody](https://github.com/yoav-lavi/melody) ⭐ 4,743 | 🐛 8 | 🌐 Rust | 📅 2024-11-24 \[[*docs*](https://yoav-lavi.github.io/melody/book/)] - A language that compiles to regexes.
* Compose with functions: [compose-regexp.js](https://github.com/compose-regexp/compose-regexp.js) ⭐ 149 | 🐛 2 | 🌐 JavaScript | 📅 2024-09-26, [VerbalExpressions](https://github.com/VerbalExpressions/JSVerbalExpressions) ⭐ 12,157 | 🐛 29 | 🌐 JavaScript | 📅 2024-08-07 (implementations for [many languages](https://verbalexpressions.github.io/)), [magic-regexp](https://github.com/unjs/magic-regexp) ⭐ 4,312 | 🐛 35 | 🌐 TypeScript | 📅 2026-02-12 \[[*home*](https://regexp.dev/)], [Super Expressive](https://github.com/francisrstokes/super-expressive) ⭐ 4,635 | 🐛 10 | 🌐 JavaScript | 📅 2024-07-05 \[[*playground*](https://nartc.github.io/ng-super-expressive/)].
...
* [arkregex](https://github.com/arktypeio/arktype/tree/main/ark/regex) ⭐ 7,614 | 🐛 231 | 🌐 TypeScript | 📅 2026-02-02 - `RegExp`-equivalent constructor with TS types.
...
Awesome Regex was created by [Steven Levithan](https://github.com/slevithan) and [contributors](https://github.com/slevithan/awesome-regex/graphs/contributors) ⭐ 352 | 🐛 0 | 📅 2025-12-14.
