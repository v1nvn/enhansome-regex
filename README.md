...
[![Awesome Regex](media/awesome-regex-banner.svg)](https://github.com/slevithan/awesome-regex) ⭐ 350 | 🐛 0 | 📅 2025-12-14
...
* [RegexLearn](https://regexlearn.com/playground) \[[*GitHub*](https://github.com/aykutkardas/regexlearn.com/blob/develop/src/pages/%5Blang%5D/playground.tsx) ⭐ 3,958 | 🐛 25 | 🌐 TypeScript | 📅 2025-06-18] - **Best multilingual tester** (JavaScript).
  * Languages: 🇺🇸, 🇹🇷, 🇷🇺, 🇪🇸, 🇨🇳, 🇩🇪, 🇺🇦, 🇫🇷, 🇵🇱, 🇰🇷, 🇧🇷, 🇨🇿, 🇬🇪.
...
* fancy-regex (Rust library): [fancy-regex playground](https://fancy-regex.github.io/fancy-regex/) \[[*GitHub*](https://github.com/fancy-regex/fancy-regex/tree/main/playground) ⭐ 571 | 🐛 15 | 🌐 Rust | 📅 2026-02-09].
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 59,727 | 🐛 113 | 🌐 Rust | 📅 2025-12-17 - Better and faster grep. Recursively searches directories while respecting gitignore rules and skipping hidden/binary files.
...
* [PowerGREP](https://www.powergrep.com/) (Windows, $159) - Can search through archives, binary files, PDFs, docs/sheets, emails, etc., via its GUI or the command line.
  * Flavors: Emulates hundreds of flavors/versions.
* [PowerRename](https://github.com/microsoft/PowerToys) ⭐ 129,183 | 🐛 8,116 | 🌐 C# | 📅 2026-02-10 (Windows) - Rename files using regexes.
...
* [The Modern JavaScript Tutorial: Regular expressions](https://javascript.info/regular-expressions) \[[*GitHub*](https://github.com/javascript-tutorial/en.javascript.info) ⭐ 25,116 | 🐛 510 | 🌐 HTML | 📅 2025-11-20] - Guide to using regexes in JavaScript.
...
* [RegexLearn](https://regexlearn.com/) \[[*GitHub*](https://github.com/aykutkardas/regexlearn.com) ⭐ 3,958 | 🐛 25 | 🌐 TypeScript | 📅 2025-06-18] - Interactive tutorial and practice problems.
  * Languages: 🇺🇸, 🇹🇷, 🇷🇺, 🇪🇸, 🇨🇳, 🇩🇪, 🇺🇦, 🇫🇷, 🇵🇱, 🇰🇷, 🇧🇷, 🇨🇿, 🇬🇪.
...
* RE2: [Syntax](https://github.com/google/re2/wiki/Syntax) ⭐ 9,594 | 🐛 12 | 🌐 C++ | 📅 2026-01-22.
...
* [Python: re](https://github.com/python/cpython/tree/main/Lib/re) ⭐ 71,437 | 🐛 9,202 | 🌐 Python | 📅 2026-02-10 and [regex](https://github.com/mrabarnett/mrab-regex) ⭐ 573 | 🐛 79 | 🌐 C | 📅 2026-01-14 - Standard and extended regex libraries.
* JavaScript:
  * [V8: Irregexp](https://github.com/v8/v8/tree/main/src/regexp) ⭐ 24,833 | 🐛 7 | 🌐 C++ | 📅 2026-02-10 - Regex engine used by Chrome, Edge, [Firefox](https://hacks.mozilla.org/2020/06/a-new-regexp-engine-in-spidermonkey/), etc.
  * [JavaScriptCore: RegExp](https://github.com/WebKit/WebKit/blob/main/Source/JavaScriptCore/runtime/RegExp.cpp) ⭐ 9,597 | 🐛 1,851 | 🌐 JavaScript | 📅 2026-02-10 - Regex engine used by Safari.
* [Java: java.util.regex](https://github.com/openjdk/jdk/tree/master/src/java.base/share/classes/java/util/regex) ⭐ 22,480 | 🐛 391 | 🌐 Java | 📅 2026-02-10 - JDK standard regexes.
* [.NET: System.Text.RegularExpressions](https://github.com/dotnet/runtime/tree/main/src/libraries/System.Text.RegularExpressions) ⭐ 17,555 | 🐛 8,395 | 🌐 C# | 📅 2026-02-10 - Shared by all .NET languages (C#, VB, etc.).
* [RE2](https://github.com/google/re2) ⭐ 9,594 | 🐛 12 | 🌐 C++ | 📅 2026-01-22 - Popular C++ regex library used by Go, etc. Non-backtracking engine.
* [Hyperscan](https://github.com/intel/hyperscan) ⭐ 5,305 | 🐛 194 | 🌐 C++ | 📅 2025-04-02 - Intel's high-performance library, used for [DPI](https://en.wikipedia.org/wiki/Deep_packet_inspection).
* [Rust: regex](https://github.com/rust-lang/regex) ⭐ 3,897 | 🐛 54 | 🌐 Rust | 📅 2026-02-03 - Non-backtracking engine.
* [ICU](https://github.com/unicode-org/icu/blob/main/icu4c/source/i18n/regexcmp.cpp) ⭐ 3,406 | 🐛 103 | 🌐 C++ | 📅 2026-02-09 - Unicode org's package with full Unicode support.
* [Oniguruma](https://github.com/kkos/oniguruma) ⚠️ Archived - C regex library used by Ruby 1.9, TextMate grammars, etc.
* [Perl](https://github.com/Perl/perl5/blob/blead/regexp.h) ⭐ 2,230 | 🐛 2,389 | 🌐 Perl | 📅 2026-02-09 - See [perlreguts](https://perldoc.perl.org/perlreguts).
...
* [recheck](https://github.com/makenowjust-labs/recheck) ⭐ 289 | 🐛 12 | 🌐 Scala | 📅 2026-02-08 \[[*home*](https://makenowjust-labs.github.io/recheck/)] - JavaScript and Scala library for detecting ReDoS vulnerability. Can be used as an ESLint plugin.
...
* [arkregex](https://github.com/arktypeio/arktype/tree/main/ark/regex) ⭐ 7,606 | 🐛 231 | 🌐 TypeScript | 📅 2026-02-02 - `RegExp`-equivalent constructor with TS types.
...
* Generate strings that match a given regex: [randexp.js](https://github.com/fent/randexp.js) ⭐ 1,869 | 🐛 14 | 🌐 JavaScript | 📅 2025-11-23, [regex-to-strings](https://github.com/wimpyprogrammer/regex-to-strings) ⭐ 33 | 🐛 4 | 🌐 TypeScript | 📅 2026-01-29.
* [eslint-plugin-regexp](https://github.com/ota-meshi/eslint-plugin-regexp) ⭐ 755 | 🐛 17 | 🌐 TypeScript | 📅 2026-02-09 \[[*home*](https://ota-meshi.github.io/eslint-plugin-regexp/)] - ESLint plugin for finding regex mistakes, etc.
...
Awesome Regex was created by [Steven Levithan](https://github.com/slevithan) and [contributors](https://github.com/slevithan/awesome-regex/graphs/contributors) ⭐ 350 | 🐛 0 | 📅 2025-12-14.
